...
export const ExtractDataFromUploadedFile = backend.integrations.Core.ExtractDataFromUploadedFile;
export const CreateFileSignedUrl = backend.integrations.Core.CreateFileSignedUrl;
export const UploadPrivateFile = backend.integrations.Core.UploadPrivateFile;
